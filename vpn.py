...
class Wireguard:
    ...
    def create_instance(self, name: str, private_key: str, public_key: str, listen_port: str, allowed_ips: list[str]) -> None:
    ...
    def add_peer(self, name: str, peer_id: str, peer_public_key: str, peer_allowed_ips: list[str], route_allowed: str = "1", keepalive: str = "25") -> None:
...
class OpenVPN:
    ...
    def create_instance(self, name: str, protocol:str,  port: str, ca_path: str, cert_path: str, key_path: str, remote_host: str, ip: str, mask: str) -> None:
